    ...
    <div className="min-h-screen">
      ...
      <div className="px-8 pt-6 pb-4 border-b border-ink-700">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-serif font-bold text-ink-50">Generator</h1>
            <p className="text-ink-500 text-sm mt-0.5">Assemble prompts using The Ink Register style system</p>
          </div>
